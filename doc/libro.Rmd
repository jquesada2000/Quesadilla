...
vignette: >
  %\VignetteIndexEntry{Bioestadística Básica}
...
En este documento se muestra el codigo R utilizado en el Libro "Bioestadística Básica y Avanzada con R", publicado por la Editorial Diaz de Santos en 2024. Se incluye el codigo de la primera parte del libro: I Bioestadística Básica.
...
```
## Análisis bivariante con Repuesta Categórica de 2 categorías
```{r eval=FALSE}
...
```
## Análisis bivariante con Repuesta Continua
```{r eval=FALSE}
...
```
## Análisis bivariante con Repuesta Categórica de 3 categorías
```{r eval=FALSE}
...
```
## Analisis bivariante para correlaciones
```{r eval=FALSE}
